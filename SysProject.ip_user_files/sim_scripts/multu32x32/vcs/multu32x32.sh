...
# executing this script. Please type 'multu32x32.sh -help' for more information.
#
...
reset_run()
{
  files_to_remove=(ucli.key multu32x32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc multu32x32_simv.daidir)
...
compile()
{
  ...
  vhdlan -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../SysProject.srcs/sources_1/ip/multu32x32/sim/multu32x32.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.multu32x32 -o multu32x32_simv
}
...
simulate()
{
  ...
  ./multu32x32_simv $opts -do simulate.do
}
# Script usage
usage()
{
