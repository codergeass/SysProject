...
#
# Generated by Vivado on Mon Jan 09 17:02:51 +0800 2017
...
# Script info
echo -e "cpu_clk.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./cpu_clk.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../../SysProject.srcs/sources_1/ip/cpu_clk/cpu_clk_clk_wiz.v" \
    "$ref_dir/../../../../SysProject.srcs/sources_1/ip/cpu_clk/cpu_clk.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.cpu_clk xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.cpu_clk -input simulate.do
}
# Script usage
usage()
{
